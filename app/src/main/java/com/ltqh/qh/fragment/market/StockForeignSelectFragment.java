...
public class StockForeignSelectFragment extends BaseFragment implements View.OnClickListener {
    ...
    private StockForeignTabAdapter stockForeignTabAdapter;


    @SuppressLint("ValidFragment")
    public StockForeignSelectFragment(String id, String title) {
        this.SORT = id;
        this.TITLE = title;
    }
    ...
    protected void initView(View view) {
        stockForeignTabAdapter = new StockForeignTabAdapter(getActivity());
    ...
    private void showPopWindow() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.item_popforeign_layout, null);
        ...
        view.findViewById(R.id.layout_zhangdiee).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                text_paihangbang.setText("纳斯达克交易所");
                SORT = "O";
                popupWindow.dismiss();
        ...
        view.findViewById(R.id.layout_chegnjiaoliang).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                text_paihangbang.setText("美国交易所");
                SORT ="A";
                popupWindow.dismiss();
