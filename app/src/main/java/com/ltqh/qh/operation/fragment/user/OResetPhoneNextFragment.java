...
public class OResetPhoneNextFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected int setLayoutResourceID() {
        return R.layout.o_fragment_reset_next_phone;
    }
    ...
    private void getCode(String username, String imgcode) {
        OkGo.<String>post(OConstant.URL_MOBILE)
                .tag(this)
                .params(OConstant.PARAM_ACTION, OConstant.STAY_SEND_VERIFY_NEW)
