...
public class OBankListSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<OwithdrawEntity.BankCardsBean> datas;


    private Context context;

    public OBankListSelectAdapter(Context context) {
        this.context = context;
        datas = new ArrayList<>();
    }

    public void setDatas(List<OwithdrawEntity.BankCardsBean> datas) {
        this.datas = datas;
        this.notifyDataSetChanged();
    }

    public void addDatas(List<OwithdrawEntity.BankCardsBean> datas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.o_banklist_select_layout, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            String cardNumber = datas.get(position).getCard();
    ...
    public interface OnItemClick {
        void onSuccessListener(OwithdrawEntity.BankCardsBean data);
