...
public class OWithdrawHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<OWithdrawHistoryEntity.InoutsBean> datas;


    private Context context;

    public OWithdrawHistoryAdapter(Context context) {
        this.context = context;
        datas = new ArrayList<>();
    }

    public void setDatas(List<OWithdrawHistoryEntity.InoutsBean> datas) {
        this.datas = datas;
        this.notifyDataSetChanged();
    }

    public void addDatas(List<OWithdrawHistoryEntity.InoutsBean> datas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.o_withdraw_history_layout, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).text_name.setText(datas.get(position).getBankCard());
    ...
    public interface OnItemClick {
        void onSuccessListener(OWithdrawHistoryEntity.InoutsBean data);
