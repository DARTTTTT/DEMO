...
public class BookAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<BookContentEntity.ResultBean.DataBean> datas;
    ...
    public void setDatas(List<BookContentEntity.ResultBean.DataBean> datas) {
        this.datas = datas;
        this.notifyDataSetChanged();
    }

    public void addDatas(List<BookContentEntity.ResultBean.DataBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            ((MyViewHolder) holder).text_catalog.setText(datas.get(position).getCatalog());
            ((MyViewHolder) holder).text_tag.setText(datas.get(position).getTags());
            ((MyViewHolder) holder).text_read.setText(datas.get(position).getReading()+"人已买");
            String thumbnail = datas.get(position).getImg();
            if (!thumbnail.equals("")) {
                Glide.with(context)
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView text_title, text_catalog, text_tag,text_read;
        XCRoundRectImageView thumbnail;

        public MyViewHolder(View itemView) {
            super(itemView);
            text_title = (TextView) itemView.findViewById(R.id.text_title);
            text_tag=itemView.findViewById(R.id.text_tags);
            text_catalog=itemView.findViewById(R.id.text_catalog);
            text_read=itemView.findViewById(R.id.text_readcount);
