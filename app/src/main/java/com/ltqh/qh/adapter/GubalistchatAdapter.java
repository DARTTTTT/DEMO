...
public class GubalistchatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GubalistchatAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_gubalistchat_layout, parent, false);
