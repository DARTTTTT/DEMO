...
public class StockforeignslideAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StockforeignslideAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_stockslide_layout, parent, false);
